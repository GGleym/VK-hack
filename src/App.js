        ...
        <View activePanel={activePanel}>
            <Panel id="panel1">
                ...
                <Group>
                    ...
                    <div style={{textAlign: 'center'}}><a style={{textDecoration: 'none', textTransform: 'uppercase', fontSize: '20px', color: '#1D94A4'}} href={'www.spatial.io'}>Начать путешествие</a></div>
                    <div style={{ height: 50 }} />
                    <CellButton onClick={() => setActivePanel('panel2')}>Перейти к Arcona</CellButton>
            ...
            <Panel id="panel2">
                ...
                <Group>
                    <CellButton onClick={() => setActivePanel('panel1')}>Назад к Spatial</CellButton>
                    ...
                    <div style={{textAlign: 'center'}}><a style={{textDecoration: 'none', textTransform: 'uppercase', fontSize: '20px', color: '#1D94A4'}} href={'www.spatial.io'}>Начать путешествие</a></div>
                    <div style={{ height: 50 }} />
                    <CellButton onClick={() => setActivePanel('panel3')}>Перейти к Decentraland</CellButton>
                    <div style={{ height: 100 }} />
                </Group>
            </Panel>
            <Panel id="panel3">
                ...
                <Group>
                    <CellButton onClick={() => setActivePanel('panel2')}>Назад к Arcona</CellButton>
                    ...
                    <div style={{textAlign: 'center'}}><a style={{textDecoration: 'none', textTransform: 'uppercase', fontSize: '20px', color: '#1D94A4'}} href={'www.spatial.io'}>Начать путешествие</a></div>
                    <div style={{ height: 50 }} />
                    <CellButton onClick={() => setActivePanel('panel4')}>Перейти к Fortnite</CellButton>
                    <div style={{ height: 100 }} />
                </Group>
            </Panel>
            <Panel id="panel4">
                ...
                <Group>
                    <CellButton onClick={() => setActivePanel('panel3')}>Назад к Decentraland</CellButton>
                    <Verse mainImage={<ImageFortnite />} captionText={"Fortnite"}
                                  ...
                                  thirdParagraph={(<ul>
                                      <li>В апреле 2020 года рэпер Трэвис Скотт провёл концерт в Fortnite, который одновременно смотрело более 12 млн игроков.</li>
                                      <li>В декабре 2019 года Disney устроила премьеру отрывка из девятого эпизода «Звёздных войн», а также провела живое интервью с режиссёром фильма Джей Джей Абрамсом. Само событие упомянуто в фильме.</li>
                                      <li>Группа Weezer создала остров, где игроки могли эксклюзивно послушать новый альбом.</li>
                                      <li>Epic Games устраивает внутри Fortnite ограниченные по времени события, привязанные к релизам в реальном мире. Карта игры трансформируется в виртуальный мир, который меняет стиль и внутриигровые объекты в партнерстве с брендами: DC, Nike, Lionsgate, Marvel, Microsoft, Sony и другими. Так Fortnite стал местом, где пересекаются разные вселенные: игроки могут буквально носить костюм персонажа Marvel внутри Готэма, общаясь с другом в лицензированной форме НФЛ.</li>
                                      <li>У игроков есть возможность создавать и свой контент через творческий режим в Fortnite, а также монетизировать его. Это могут быть эмоции, костюмы, игровые механики и миры. По своей сути творческий режим Fortnite — это «прото-метавселенная», утверждает Болл: игроки могут загружать свой уникальный Fortnite-аватар в лобби и выбирать из тысяч миров, созданных другими игроками.</li>
                                  </ul>)}/>
                    <div style={{textAlign: 'center'}}><a style={{textDecoration: 'none', textTransform: 'uppercase', fontSize: '20px', color: '#1D94A4'}} href={'www.spatial.io'}>Начать путешествие</a></div>
                    <div style={{ height: 50 }} />
                    <CellButton onClick={() => setActivePanel('panel5')}>Перейти к Roblox</CellButton>
                    <div style={{ height: 100 }} />
                </Group>
            </Panel>
            <Panel id="panel5">
                ...
                <Group>
                    <CellButton onClick={() => setActivePanel('panel4')}>Назад к Fortnite</CellButton>
                    ...
                    <div style={{textAlign: 'center'}}><a style={{textDecoration: 'none', textTransform: 'uppercase', fontSize: '20px', color: '#1D94A4'}} href={'www.spatial.io'}>Начать путешествие</a></div>
                    <div style={{ height: 50 }} />
                    <CellButton onClick={() => setActivePanel('panel6')}>Перейти к Российской Деловой Метавселенной Матрёшке Ренессанс</CellButton>
                    <div style={{ height: 100 }} />
                </Group>
            </Panel>
            <Panel id="panel6">
                ...
                <Group>
                    <CellButton onClick={() => setActivePanel('panel5')}>Назад к Roblox</CellButton>
                    <Verse mainImage={<ImageRussian />} captionText={"Российская Деловая Метавселенная Матрёшка Ренессанс"}
                    ...
                    <div style={{textAlign: 'center'}}><a style={{textDecoration: 'none', textTransform: 'uppercase', fontSize: '20px', color: '#1D94A4'}} href={'www.spatial.io'}>Начать путешествие</a></div>
                    <div style={{ height: 50 }} />
                    <CellButton onClick={() => setActivePanel('panel7')}>Перейти к Sandbox</CellButton>
                    <div style={{ height: 100 }} />
                </Group>
            </Panel>
            <Panel id="panel7">
                ...
                <Group>
                    <CellButton onClick={() => setActivePanel('panel6')}>Назад к Российской Деловой Метавселенной Матрешке Ренессанс</CellButton>
                    <Verse mainImage={<ImageSandbox />} captionText={"The Sandbox"}
                                  ...
                                  thirdParagraph={(<ul>
                                      ...
                                      <li>1 метр или блок, состоит из 32 вокселей в длину, 32 вокселей в ширину и 32 вокселей в высоту.</li>
                                  </ul>)}/>
                    <div style={{textAlign: 'center'}}><a style={{textDecoration: 'none', textTransform: 'uppercase', fontSize: '20px', color: '#1D94A4'}} href={'www.spatial.io'}>Начать путешествие</a></div>
                    <div style={{ height: 50 }} />
                    <CellButton onClick={() => setActivePanel('panel8')}>Перейти к Sensorium</CellButton>
                    <div style={{ height: 100 }} />
                </Group>
            </Panel>
            <Panel id="panel8">
                ...
                <Group>
                    <CellButton onClick={() => setActivePanel('panel7')}>Назад к The Sandbox</CellButton>
                    ...
                    <div style={{textAlign: 'center'}}><a style={{textDecoration: 'none', textTransform: 'uppercase', fontSize: '20px', color: '#1D94A4'}} href={'www.spatial.io'}>Начать путешествие</a></div>
                    <div style={{ height: 50 }} />
                    <CellButton onClick={() => setActivePanel('panel9')}>Перейти к Somnium Space</CellButton>
                    <div style={{ height: 100 }} />
                </Group>
            </Panel>
            <Panel id="panel9">
                ...
                <Group>
                    <CellButton onClick={() => setActivePanel('panel8')}>Назад к Sensorium</CellButton>
                    ...
                    <div style={{textAlign: 'center'}}><a style={{textDecoration: 'none', textTransform: 'uppercase', fontSize: '20px', color: '#1D94A4'}} href={'www.spatial.io'}>Начать путешествие</a></div>
                    <div style={{ height: 50 }} />
                    <CellButton onClick={() => setActivePanel('panel1')}>Назад к первой Метавселенной!</CellButton>
                    <div style={{ height: 100 }} />
                </Group>
            </Panel>
        </View>
